<?php
$sApplicationId = '1908175546066656';
$sApplicationSecret = '1a493dc762c6f226924a999b9c4cec0b';
$iLimit = 999;
?>
<!DOCTYPE html>
...
userInfo.innerHTML = '<img src="https://graph.facebook.com/' + response.id + '/picture">' + response.name + response.emailid;

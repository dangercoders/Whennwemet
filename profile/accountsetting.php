...
<body >
 ...
 <!-- <div class="row">
    <div class="col-sm-10 col-sm-offset-1" id="logout">
        <div class="comment-tabs">
                    <form action="changepassword.php" method="post" class="form-horizontal" id="accountSetForm" role="form" enctype="multipart/form-data">
                        <div class="form-group">
                            <div class="col-sm-10">                                
                                <div class="custom-input-file" id="preview">
                                <img id="previewing" src="" style="width:120px; height:120px;"/>
  ...
  -->
   ...
   <!-- <script>
	$("#previewing").attr("src",localStorage.getItem('uprofilepic'));
	</script> -->
</body>
</html>

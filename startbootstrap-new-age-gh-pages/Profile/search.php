...
if (strlen($search_string) >= 1 && $search_string !== ' ') {
	...
	echo'<div class="row">
		...
		foreach ($result_array as $result) {
			...
			$display_url = 'http://whennwemet.com/'.urlencode($result['name']);
			
			echo'<a href="'; echo $display_url; echo'"><li class="list-group-item">
                        <div class="col-xs-12 col-sm-3">
                            <img src="http://api.randomuser.me/portraits/men/49.jpg" alt="Scott Stevens" class="img-responsive img-circle" width="80px"/>
                        </div>
